...
\date{\today}
\background{../figures/comunes/background.jpg}
\begin{document}
\input{postamble}
\maketitle
...
\begin{center}
    \includegraphics[width=0.7\linewidth]{fig/daqs.jpg}
\end{center}
\end{frame}

\begin{frame}{Señales}
\begin{center}
    \includegraphics[width=0.8\linewidth]{fig/analogicavrsdigital.jpg}
\end{center}
\end{frame}

\begin{frame}{Analógica}
\begin{center}
    \includegraphics[width=0.8\linewidth]{fig/analogsignal.png}
\end{center}
\end{frame}

\begin{frame}{Digital}
\begin{center}
    \includegraphics[width=0.7\linewidth]{fig/digitalsignal.png}
\end{center}
\end{frame}

\begin{frame}{Etapas de la conversión A/D}
\begin{center}
    \includegraphics[width=0.93\linewidth]{fig/convAD.jpg}
\end{center}
\end{frame}

\begin{frame}{Muestreo, cuantización y codificación}
\begin{center}
    \includegraphics[width=0.9\linewidth]{fig/muestreo.jpg}
\end{center}
\end{frame}
...
\begin{frame}{Muestreo}
    ...
    \begin{column}{0.6\textwidth}
        \begin{center}
            \includegraphics[width=0.9\linewidth]{fig/sampling.png}  
        \end{center}
    \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Cuantización}
    ...
    \begin{column}{0.6\textwidth}
        \begin{center}
            \includegraphics[width=0.8\linewidth]{fig/resolution.png}  
        \end{center}
    \end{column}
    \end{columns}
\end{frame}
...
\begin{center}
    \includegraphics[width=0.4\linewidth]{fig/SAR.png}
...
\begin{frame}{Ejemplo: aproximación sucesiva}
        \centering
        \includegraphics[width=0.9\textwidth]{fig/SARplots.png}
\end{frame}
